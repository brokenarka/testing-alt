            ...
            <div className="p-6 flex-1 flex flex-col gap-10">
                ...
                <div className="flex gap-4 flex-1">
                    ...
                    <div className="basis-1/4 bg-white rounded-lg shadow-md p-4 flex flex-col gap-5">
                        ...
                        <button className="border-orange-600 border px-10 py-2 text-sm  rounded-full w-fit mt-6 ">
                            Reschedule
                        </button>
                        <button className="bg-orange-600 border-orange-600 border px-10 py-2 text-sm text-white rounded-full w-fit mt-2 ">
                            Assign a New Doctor
                        </button>
                    </div>
                </div>
